...
This folder contains images and photos of the Automatic Irrigation System.
...
- `lcd-display.jpg` - LCD showing status
- `water-pump.jpg` - 12V water pump
...
- `outdoor-installation.jpg` - Complete outdoor setup
...
1. **File Naming Convention:**
   ...
   - Be descriptive: `component-name-view.jpg`
   - Examples: `moisture-sensor-installed.jpg`, `relay-board-connections.jpg`
...
3. **Photo Tips:**
   - Use good lighting
   - Focus on component/connection
   - Include context when helpful
   - Show labels/annotations if needed
   - Take multiple angles

4. **Documentation:**
   - Update this README with new images
   - Reference images in relevant documentation
...
Your contributions help others build and understand the project better!

---

**Copyright Notice:**

By contributing images, you agree to license them under the same MIT license as the project. Only submit images you have the rights to share.
